...
| T06 | 服务管理 | 内置 supervisor | `04-atom-supervisor.md` |
| T07 | 周期任务 | 内置 scheduler | `05-atom-scheduler.md` |
...
| 编号 | 功能名称 | 依赖原子 | 规格文档 |
|------|----------|----------|----------|
| F01 | 服务管理 | T02, T06, T07 | `10-feature-systemd-service.md` |
| F02 | 周期任务管理 | T02, T07 | `11-feature-crontab.md` |
